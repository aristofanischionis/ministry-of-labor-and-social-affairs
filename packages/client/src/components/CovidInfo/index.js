    ...
    return (
        <div>
            ...
            <Grid stackable rows={4} textAlign="center">
                        ...
                        <Container>
                            ...
                            <Statistic.Group widths='three'>
                                <Statistic color="orange">
                                    <Statistic.Value><h2 className="style-text-initial">+{numberOfNewCases}</h2></Statistic.Value>
                                ...
                                <Statistic color="red">
                                    <Statistic.Value><h2 className="style-text-initial">+{numberOfNewDeaths}</h2></Statistic.Value>
                                ...
                                <Statistic color="green" floated>
                                    <Statistic.Value><h2 className="style-text-initial">+{numberOfNewRecovered}</h2></Statistic.Value>
                ...
                <Grid.Row>
                    <Container><Header as='h2' textAlign="center">Πληροφορίες για τον COVID-19</Header>  <br/></Container>
                    ...
                    <Segment>
                        ...
                        <br/>
                            <p className="style-covid-info">
                                ...
                                <ol>
                                    <li> Στενή επαφή με πιθανό ή επιβεβαιωμένο κρούσμα λοίμωξης από τον νέο κορωνοϊό SARS-CoV-2</li>
                                    <li> Ιστορικό ταξιδιού σε πληττόμενες από τον SARS-CoV-2 περιοχές με βάση τα τρέχοντα επιδημιολογικά δεδομένα.</li>
                                </ol>
                                Κάθε τέτοιο περιστατικό - ύποπτο κρούσμα θα πρέπει να υποβάλλεται ΑΜΕΣΑ σε εργαστηριακό έλεγχο
                                για τον ιό SARS-CoV-2.
                                Σε αυτή την περίπτωση συστήνεται η άμεση επικοινωνία με τον ΕΟΔΥ τηλ: <u> 210.52.12.054</u> ή <u>1135 </u> και
                ...
                <Grid.Row>
                    <Segment>
                        <Container>
                            <Header as='h3' textAlign="center"><u>Εργοδότης και COVID-19</u></Header>
                            <p className="style-covid-info">
                            ...
                            <p  className="style-covid-info">
                            Αν έχετε επιχείρηση ή είστε εργοδότης και έχει ανασταλεί η κύρια επιχειρηματική σας δραστηριότητα θα πρέπει να δηλώσετε:
                            <ul>
                                ...
                                <li>τα στοιχεία των εργαζόμενων σας που οι συμβάσεις εργασίας τους τελούν σε αναστολή ή έχουν λυθεί από 1/3/2020 έως 20/3/2020</li>
                            </ul>
                            Αν η δραστηριότητα της επιχείρησή σας ανήκει στους κλάδους που πλήττονται από την εξάπλωση του κορωνοϊού και κάνετε χρήση της δυνατότητας
                            αναστολής των συμβάσεων εργασίας μέρους ή του συνόλου του προσωπικού σας, θα πρέπει να δηλώσετε:
                            <ol>
                                <li>την αναστολή της δραστηριότητάς σας</li>
                                <li>τα στοιχεία των εργαζόμενων σας που οι συμβάσεις εργασίας τους τελούν σε αναστολή ή έχουν λυθεί από 1/3/2020 έως 20/3/2020</li>
                            </ol>
                            Για την καλύτερη εξυπηρέτησή σας, μπορείτε να υποβάλετε την υπεύθυνη δήλωση:<br/>
                            <br/>
                            <div>
                ...
                <Grid.Row>
                    <Segment>
                        <Container>
                        <Header as='h3' textAlign="center"><u>Εργαζόμενος και COVID-19</u></Header>
                            <p className="style-covid-info">
                            ...
                            <li>τα στοιχεία του εκμισθωτή και του μισθίου ακινήτου, αν δικαιούστε και τη μείωση ενοικίου</li>
                            </ol>
                            Για την καλύτερη εξυπηρέτησή σας, μπορείτε να υποβάλετε την υπεύθυνη δήλωση:<br/>
                            <ul>
                            ...
                            Η χρονική περίοδος υποβολής μπορεί να παραταθεί, αν χρειαστεί.<br/>
                            <br/>
                            <div>
                            <Button animated color='blue'>
                                <Button.Content visible>Είσοδος στην υπηρεσία</Button.Content>
