          ...
          <Link to="/COVID-info">
            <Card>
              ...
              <Card.Content>
                ...
                <Card.Description>
                  Οι κατευθυντήριες οδηγίες βασίζονται σε αντίστοιχες οδηγίες και συστάσεις του
                  Εθνικού Οργανισμού Δημόσιας Υγείας (Ε.Ο.Δ.Υ.), της Γενικής Γραμματείας Πολιτικής
                  Προστασίας (ΓΓΠΠ) και του Παγκόσμιου Οργανισμού Υγείας (ΠΟΥ).
                </Card.Description>
              </Card.Content>
            </Card>
          </Link>
          ...
          <Link to="/tilergasia-odigies">
            <Card>
              ...
              <Card.Content>
                ...
                <Card.Description>
                  Oι εργοδότες θα πρέπει μέσα στην ημέρα να δηλώσουν στο σύστημα, τους εργαζόμενους,
                  που αναμένεται να απασχοληθούν με τηλεργασία.
                </Card.Description>
              </Card.Content>
            </Card>
          </Link>
          ...
          <Link to="/epidoma-800-euro">
            <Card>
              ...
              <Card.Content>
                ...
                <Card.Description>
                  Πάνω από 33.000 εργαζόμενοι δεν κατέστη εφικτό να εισπράξουν την ειδική αποζημίωση
                  Νοεμβρίου με βάση τα 800 ευρώ. Που πρέπει να υποβάλλουν δήλωση για να τα λάβουν
                </Card.Description>
              </Card.Content>
            </Card>
          </Link>
