...
const panes = [
  ...
  },
  {
    ...
    render: () => (
      <Tab.Pane attached={true}>
        <p className="style-covid-info">
        <Header as="h4"> Μέτρα πρόληψης στους χώρους της επιχείρησης/εργασίας</Header>
          Η πανδημία Covid-19 είναι μια νεοεμφανιζόμενη ασθένεια με διαρκείς εξελίξεις όσο αφορά
          τα επιστημονικά δεδομένα. Ο Π.Ο.Υ. συστήνει τους εξής βασικούς κανόνες υγιεινής που
          πρέπει να τηρούνται για την πρόληψη του Covid-19.
          <ol>
            <li>
              Συχνό πλύσιμο των χεριών
            </li>
            <li>
              Ιχρήση προστατευτικών μέσων και 
            </li>
            <li>
          ...
          <ol>
            <li>
              Αποτροπή της εισόδου κρουσμάτων στην επιχείρηση
            </li>
            <li>
              Αποτροπή της εξάπλωσης μέσα στην επιχείρηση
            </li>
            <li>
              Αποτροπή της εξάπλωσης στην ευρύτερη κοινότητα (και σε ευάλωτα άτομα)
            </li>
            <li>
              Μείωση των επιπτώσεων στην παραγωγή 
            </li>
          </ol>
          Οι οδηγίες υπάγονται σε τέσσερις γενικούς τίτλους:
          <ol>
            <li>
              Μέτρα πρόληψης και ελέγχου της μόλυνσης σε διαρκή ισχύ για την πρόληψη της
              επιδημίας - στην είσοδο, της εγκατάστασης, στους χώρους εστίασης, στις περιοχές
              παραγωγής, στα αποδυτήρια τις τουαλέτες, κλπ.
            </li>
            <li>
              Εξωτερικούς παράγοντες στο εργασιακό περιβάλλον 
            </li>
            <li>
              Μέτρα που πρέπει να ληφθούν σε υπόνοια ή επιβεβαίωση κρούσματος
            </li>
            <li>
              Πρόσθετα μέτρα που πρέπει να ληφθούν μετά την επιβεβαίωση κρούσματος
            </li>
          </ol>
          <Header as="h4"> 1. Μέτρα σε διαρκή ισχύ για την πρόληψη της επιδημίας</Header>
          Σταθμός ελέγχου όπου κάθε υπάλληλος – επισκέπτης που εισέρχεται ελέγχεται από
          κατάλληλα εκπαιδευμένο άτομο με:
          <ol>
            <li>
              Ερωτηματολόγιο διαλογής 
            </li>
            <li>
              Εξοπλισμό ελέγχου της θερμοκρασίας. Κανείς δεν εισέρχεται στην εγκατάσταση εάν
              από το ερωτηματολόγιο διαπιστωθεί ότι έχει συμπτώματα της νόσου ή θερμοκρασία
              υψηλότερη από 37,5C.
            </li>
          </ol>
            Ρυθμίσεις κοινωνικής αποστασιοποίησης: 2 μέτρα κατά την αναμονή με σήμανση
            του δαπέδου
          <ol>
            <li>
              Τήρηση κλιμακωτού ωραρίου
            </li>
            <li>
              Απαγόρευση περιττών επισκέψεων
            </li>
          </ol>
          <Header as="h4"> 2. Μέτρα που πρέπει να ληφθούν σε υπόνοια ή επιβεβαίωση κρούσματος </Header>
          <b>Βήματα που πρέπει να ληφθούν όταν υπάρχει υπόνοια ή επιβεβαίωση μεμονωμένης
          περίπτωσης COVID-19</b>
          <ol>
            <li>
              Οποιοσδήποτε υπάλληλος αποτύχει στο ερωτηματολόγιο διαλογής ή στον έλεγχο της
              θερμοκρασίας κατά την είσοδο στην εγκατάσταση πρέπει να απομακρυνθεί και να
              εξεταστεί 
            </li>
            <li>
              Κάθε μέλος του προσωπικού που εμφανίζει συμπτώματα κατά τη διάρκεια της
              εργασίας θα πρέπει να απομονωθεί αμέσως, να σταλεί στο σπίτι και να επικοινωνήσει
              με τον Ε.Ο.Δ.Υ.
            </li>
            <li>
              Θα πρέπει να υπάρχει ένας χώρος απομόνωσης για τους συμπτωματικούς ασθενείς
            </li>
          </ol>
          <b>Πρωτόκολλο που ακολουθείται σε περίπτωση που ένας υπάλληλος ζει με άτομο που
          θεραπεύει ασθενείς Covid-19 ή έχει θετικό άτομο Covid-19 στο σπίτι του.</b>
          <ol>
            <li>
              Επιβεβαιώνεται ότι ο εργαζόμενος έχει ήδη εφαρμόσει διαδικασίες για την
              ελαχιστοποίηση του κινδύνου μετάδοσης στο σπίτι σύμφωνα με τις οδηγίες Ε.Ο.Δ.Υ.
            </li>
            <li>
          ...
          <b>Βήματα που ακολουθούνται μετά την πληροφόρηση ότι ένας υπάλληλος / που ήλθε σε επαφή
          με τους υπόλοιπους υπαλλήλους ελέγχεται για στο Covid-19</b>
          <ol>
            <li>
              Ενημέρωση όλων των υπαλλήλων ότι αναμένονται τα αποτελέσματα των δοκιμών
            </li>
            <li>
              Ταυτοποίηση των υπαλλήλων που ήρθαν σε στενή επαφή με το άτομο κατά τις
              τελευταίες 72 ώρες, διατηρώντας το απόρρητο του ατόμου.
            </li>
            <li>
              Εφόσον είναι δυνατό, απομάκρυνση όλων των υπαλλήλων που ήρθαν σε επαφή με το
              άτομο που ελέγχεται .μέχρι να είναι διαθέσιμα τα αποτελέσματα των εξετάσεων
            </li>
            <li>
              Επιμελή καθαριότητα και απολύμανση των «ύποπτων» επιφανειών.
            </li>
            <li>
              Προσαρμογές στην εργασία άλλων υπαλλήλων για την αντικατάσταση των απόντων
            </li>
          </ol>
        </p>
      </Tab.Pane>
    ...
    render: () => (
      <Tab.Pane attached={true}>
        <p className="style-covid-info">
          ...
          <b>Επισημαίνεται ότι η διάδοση του κορωνοϊού στην κοινότητα-εργασιακούς χώρους και ο
          ...
          <ol>
            <li>
              Οργανωτικά μέτρα πχ <b>Να αποφεύγονται οι κάθε μορφής εκδηλώσεις, να μετατεθούν μελλοντικά όλες οι προγραμματισμένες δραστηριότητες 
              που συνεπάγονται συναθροίσεις ατόμων (σεμινάρια, ημερίδες, συμπόσια κ.λπ.).</b>
            </li>
            <li>
              ...
              <b>
                ...
                προτροπή και επίβλεψη της συμμόρφωσης των εργαζομένων και των τρίτων για την εφαρμογή ορθών πρακτικών ατομικής υγιεινής,
                αποφυγή κατανάλωσης κάθε είδους τροφής στους εργασιακούς χώρους, εκτός των χώρων εστίασης και 
                παροχή των κατάλληλων ατομικών μέσων προστασίας μιας χρήσης
              </b>
            </li>
            <li>
              Περιβαλλοντικά μέτρα όπως πχ <b> τον επαρκή αερισμό των εργασιακών χώρων, τον συστηματικό καθαρισμό των χώρων 
              και των επιφανειών εργασίας καθώς και των κοινόχρηστων χώρων, την απολύμανση μέσω ψεκασμού κ.λ.π</b>
            </li>
          </ol>
        </p>
      </Tab.Pane>
    ...
    render: () => (
      <Tab.Pane attached={true}>
        ...
        <ol>
          ...
          Β. Όταν βήχουμε ή φταρνιζόμαστε, καλύπτουμε το στόμα μας με τον αγκώνα ή ένα χαρτομάντιλο και
        ...
        <ol>
            <li>
              ενημερώνουμε τον εργοδότη ή την
              υπηρεσία μας
            </li>
            <li>
            ...
            <li>
            επικοινωνούμε με τον ΕΟΔΥ (τηλέφωνα
  ...
  return (
    <Grid>
      ...
      <Grid.Row centered className="image-coloring-covinfo2">
        <Header style={{'color': 'white'}} as="h3">Κορωνοϊός: Κατευθυντήριες οδηγίες.</Header>
      </Grid.Row>
      <Grid.Row>
