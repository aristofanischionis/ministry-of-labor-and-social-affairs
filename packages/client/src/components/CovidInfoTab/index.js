   ...
   {/* <Header as='h3' textAlign="center"><u>Γενικές πληροφορίες</u></Header> */}
    <br/>
        <p className="style-covid-info">
            ...
            των κορωνοϊών, μία μεγάλη οικογένεια RNA ιών.
            Σύμφωνα με τον ΠΟΥ, ο όρος SARS-CoV-2 υποδεικνύει τον ιό, ενώ ο όρος COVID-19 (Cοrona Virus Disease-2019) υποδεικνύει τη νόσο που εκδηλώνεται
