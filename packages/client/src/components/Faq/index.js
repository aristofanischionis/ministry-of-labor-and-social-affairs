...
const Level1Content = (
  <div>
    Όχι. Ο καθένας μπορεί να ενημερωθεί για θέματα σχετικά με την εργασία χωρίς λογαριασμό. Η χρήση
    προσωποποιημένου λογαριασμόυ είναι σημαντική μόνο για συγκεκριμένες λειτουργείες όπως π.χ. η
    κράτηση ραντεβού με το Υπουργείο.
  </div>
);
const Level2Content = (
  <div>
    Προσωρινά αυτή η λειτουργία δεν ειναι διαθέσιμη. Δουλεύουμε ακόμα πάνω σε αυτό. Πολύ σύντομα θα
    είναι{' '}
  </div>
);
...
const Level5Content = (
  <div>
    Η άδεια ειδικού σκοπού αποτελεί δικαίωμα κάθε εργαζόμενου και ισχύει τόσο για τον ιδιωτικό όσο
    και για τον δημόσιο τομέα. Δικαιούχοι της άδειας ειδικού σκοπού είναι οι φυσικοί, θετοί ή
    ανάδοχοι γονείς εφόσον τα παιδιά τους:
    <ol>
      ...
      <br />
      γ) φοιτούν σε ειδικά σχολεία ή σχολικές μονάδες ειδικής αγωγής και εκπαίδευσης, ανεξαρτήτως
      ορίου ηλικίας των παιδιών,
      <br />
      δ) είναι άτομα με αναπηρία και είναι ωφελούμενα σε δομές παροχής υπηρεσιών ανοικτής φροντίδας
      για άτομα με αναπηρία, ανεξαρτήτως της ηλικίας τους.
      <br />
    </ol>
  </div>
);
const Level6Content = (
  <div>
    Μπορείτε να αποταθείτε για επίδομα ανεργίας για την περίοδο που είσαστε άνεργος, ικανός και
    διαθέσιμος για εργασία. Πρέπει πρώτα να παρουσιαστείτε στο Επαρχιακό Γραφείο Εργασίας και να
    εγγραφείτε στις Υπηρεσίες Απασχόλησης για σκοπούς εξεύρεσης εργασίας. Αν το Επαρχιακό Γραφείο
    Εργασίας δε σας τοποθετήσει σε εργασία, τότε πρέπει να παρουσιαστείτε στο Επαρχιακό Γραφείο
    Κοινωνικών Ασφαλίσεων για να εγγραφείτε στο μητρώο ανέργων. Θα πρέπει να παρουσιάζεστε κατά
    τακτά χρονικά διαστήματα για υπογραφή στο μητρώο ανέργων κατά τις μέρες που ορίζει το Επαρχιακό
    Γραφείο Κοινωνικών Ασφαλίσεων. Για να πληρωθείτε επίδομα ανεργίας πρέπει επίσης να ικανοποιείτε
    τις καθορισμένες από τη νομοθεσία ασφαλιστικές προϋποθέσεις.
  </div>
);
...
const rootPanels = [
  ...
  {
    key: 'panel-5',
    title: 'Τι είναι η «Άδεια Ειδικού Σκοπού» και ποιοι είναι δικαιούχοι;',
    content: {content: Level5Content},
  },
  {
    key: 'panel-6',
    title: 'Είμαι άνεργος. Τι πρέπει να κάνω για να πληρωθώ επίδομα ανεργίας;',
